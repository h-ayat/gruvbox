...
let s:gb.dark0_hard  = ['#15181b', 234]     " 29-32-33   --- Main back color
let s:gb.dark0       = ['#282828', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 236]     " 50-48-47
let s:gb.dark1       = ['#2f2f32', 237]     " 60-56-54 -- black for other modals 3c3836
let s:gb.dark2       = ['#201f24', 239]     " 80-73-69 -- back for modals
...
let s:gb.light1      = ['#afb4be', 223]     " 235-219-178 -- default text  ebdbb2
...
let s:gb.bright_orange  = ['#61afef', 208]     " 254-128-25  -- blue for types
...
let s:gb.faded_yellow   = ['#cccf2e', 136]     " 181-118-20 -- Faded yellow b57614
let s:gb.faded_blue     = ['#076678', 24]      " 7-102-120
let s:gb.faded_purple   = ['#ea94bc', 96]      " 143-63-113
